...
const Biography = () => {
    const educations = [
        {
            id: 1, date: "2025/04 - 現在", jp: "電気通信大学 大学院情報理工学研究科 情報学専攻 博士後期課程",
            lab:"指導教員：内海彰教授", desc: "研究テーマ：言語芸術の鑑賞プロセス解明に向けた計算論アプローチの確立"
        },
        {
            id: 2, date: "2022/04 - 2025/03", jp: "電気通信大学 大学院情報理工学研究科 情報学専攻 博士前期課程",
            lab:"指導教員：内海彰教授", desc: "研究テーマ：活性拡散ネットワークとずれの解消理論に基づく詩の鑑賞過程の計算モデル"
        },
        {
            id: 3, date: "2020/04 - 2022/03", jp: "沖縄工業高等専門学校 専攻科創造システム工学専攻 情報工学コース",
            lab: "指導教員：玉城龍洋教授", desc:"研究テーマ：エコーチェンバー現象の計算モデリング"
        },
        {
            id: 4, date: "2015/04 - 2020/03", jp: "沖縄工業高等専門学校 メディア情報工学科",
            lab: "指導教員：鈴木大作准教授", desc: "研究テーマ：利用環境に応じた歌詞に基づく楽曲推薦システムの提案"
        },
    ];
