const Recent = () => {
    const news = [
        ...
        { id: 6, date: "2025/07/30 - 08/03", desc: "CogSci2025にてポスター発表しました．", title: "Chota Kameya, Tomoki Miyamoto, Akira Utsumi: A computational model of poetry appreciation based on a spreading activation network and the incongruity resolution theory, Proceedings of the 47th Annual Meeting of the Cognitive Science Society (CogSci2025) " },
