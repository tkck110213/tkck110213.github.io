const Recent = () => {
    const news = [
        { id: 1, date: "2025/04/04", desc: "電気通信大学大学院博士後期課程に入学しました．", title: "" },
        { id: 2, date: "2025/03/25", desc: "電気通信大学大学院博士前期課程を修了しました．修士（工学）が授与されました．", title: "" },
        { id: 3, date: "2024/10/12-14", desc: "日本認知科学会第41回大会にて発表しました．", title: "亀谷長太，宮本友樹，内海彰: 活性拡散ネットワークとずれの解消理論に基づく詩の鑑賞過程の計算モデル，O-6-4" },
        { id: 4, date: "2024/08/31", desc: "サイトを開設しました．", title: "" },
    ];
