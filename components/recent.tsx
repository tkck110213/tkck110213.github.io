const Recent = () => {
    const news = [
        ...
        { id: 10, date: "2026/09/15", desc: "詩の鑑賞過程の計算モデルに関する研究が，和文誌「認知科学」に採録されました．J-STAGEにて全文公開されています．", title: "活性拡散ネットワークに基づく詩の鑑賞過程の計算モデル", url: " https://doi.org/10.11225/cs.2026.036" },
