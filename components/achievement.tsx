...
const Archivements = () => {
  const publications: Publication[] = [
    { id: 5, date: "2025.7", title: "A computational model of poetry appreciation based on a spreading activation network and the incongruity resolution theory", authors: "Chota Kameya, Tomoki Miyamoto, Akira Utsumi", venue: "Proceedings of the 47th Annual Meeting of the Cognitive Science Society (CogSci2025)", review: true, international: true},
    { id: 4, date: "2024.10", title: "活性拡散ネットワークとずれの解消理論に基づく詩の鑑賞過程の計算モデル", authors: "亀谷長太，宮本友樹，内海彰", venue: "日本認知科学会第41回大会", review: false, international: false },
    { id: 3, date: "2022.11", title: "二個体協調における自由度に基づくマルチエージェント逆強化学習", authors: "植木駿介，亀谷長太，戸板佳祐，中理怡恒，髙玉圭樹，佐藤寛之", venue: "計測自動制御学会 システム・情報部門学術講演会（SSI2022）", review: false, international: false },
    { id: 2, date: "2021.9", title: "影響力を持つアカウントを考慮したエコーチェンバー現象モデルの検討", authors: "亀谷長太, 玉城龍洋", venue: "第74回電気関係学会九州支部連合大会", review: false, international: false },
    { id: 1, date: "2020.3", title: "利用環境に応じた歌詞に基づく楽曲推薦システムの検討", authors: "亀谷長太，金城篤史, 鈴木大作, 山田親稔", venue: "第10回電気学会九州支部高専研究講演会", review: false, international: false },
  ];
